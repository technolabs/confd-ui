...
(
	...
	// defaultConfig
	{
		...
		hasCache:{
			"dojo-undef-api": 1, // Added so we can 'undefine failed module loads.  This is not AMD standard, but we need it.
			"config-dojo-loader-catches":1, // This was added by XWT as it will get the loader to 'eat' errors.
			"host-browser":1,
			"dom":1,
